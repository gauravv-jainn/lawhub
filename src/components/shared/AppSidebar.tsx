...
const lawyerNav: NavItem[] = [
  ...
  { label: 'Payouts',       href: '/lawyer/payouts',    icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="1" y="3" width="14" height="10" rx="1.5" stroke="currentColor" strokeWidth="1.5"/><path d="M1 6.5h14" stroke="currentColor" strokeWidth="1.5"/><circle cx="4.5" cy="9.5" r="1" fill="currentColor"/></svg> },
