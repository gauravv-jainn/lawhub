...
const lawyerNav: NavItem[] = [
  ...
  { href: '/lawyer/proposals',  label: 'Proposals',icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><path d="M20 14a1 1 0 01-1 1H4l-3 3V3a1 1 0 011-1h17a1 1 0 011 1v11z" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg> },
];
        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              style={{ color: active ? 'var(--gold)' : 'rgba(245,240,232,0.35)', position: 'relative' }}
            >
              {active && (
                <span
                  style={{
                    position: 'absolute', top: 0, width: '24px', height: '2px',
                    background: 'var(--gold)', borderRadius: '0 0 3px 3px',
                  }}
                />
              )}
              {item.icon}
